...
public class FFprobeTest extends TestCase {
	...
	public void test() throws FileNotFoundException {
		FFprobe p = new FFprobe(new ExecutableFinder(), new CommandLineProcessor().createEmptyCommandLine("ffprobe"));
		
		int skip_base_cmdline = p.command_line.toString().length();
